...
$css = file_get_contents('style/consuldece.css');
...
<head>
    ...
    <title>Acte de décès numéro ' . $data['id'] . '</title>
    <style>' . $css . '</style>
</head>

<body>
    <main>
        <h1>Acte de décès numéro ' . $data['id'] . '</h1>
        <div class="container">
            <div class="acte">
                <div class="identite">
                    <h2>Nom :</h2>
...
$dompdf->stream('acte_deces_' . $data['id'] . '.pdf', array("Attachment" => 1));
